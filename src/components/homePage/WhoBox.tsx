...
return <div className="rounded-[0.75rem] bg-[#1F1F1F] p-[1.5rem] flex flex-col gap-5 w-full">
    ...
    <Link className="text-[#E6E9EF] text-[1rem] font-medium mt-auto" href={`/services#${link}`}>Learn More</Link>
</div>
}